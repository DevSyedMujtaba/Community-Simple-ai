...
const Index = () => {
  ...
  <div className="relative w-[444px] h-[444px] flex-shrink-0">
    {/* Rectangle: Top-left (under image) */}
    <svg
      className="absolute top-[-74px] right-[-16px] w-[328px] h-[328px] z-0"
      viewBox="0 0 328 328"
    >
    ...
    <svg
      className="absolute bottom-[40px] left-[-16px] w-[328px] h-[328px] z-0"
      viewBox="0 0 328 328"
    >
      <rect width="328" height="328" fill="none" stroke="#3B82F6" strokeWidth="3" />
    </svg>
    ...
    <svg
      className="absolute top-[-46px] left-[-40px]  w-[113px] h-[113px] z-0"
      viewBox="0 0 213 213"
    >
      <circle
        cx="106.5"
    ...
    <div className="relative z-10 w-full h-full">
      <img
        src={img1}
        alt="Happy couple in front of house"
        className="w-[444px] h-[390px] object-cover rounded-md shadow-lg border border-gray-100"
      />
    </div>
  </div>
...
<section className="w-full flex flex-col md:flex-row items-center justify-center px-4 py-16 bg-white">
  {/* Left: Image with blue shapes (reuse previous left-side image section) */}
  <div className="relative w-[320px] h-[320px] sm:w-[400px] sm:h-[400px] flex-shrink-0 mb-10 md:mb-0 md:mr-12">
    {/* Bottom-right blue square (behind image) */}
    <svg
      className="absolute bottom-0 right-0 w-[90%] h-[90%] z-0"
      viewBox="0 0 256 256"
    >
      <rect x="0" y="0" width="256" height="256" fill="none" stroke="#3B82F6" strokeWidth="3" />
    </svg>
    {/* Top-left blue square */}
    <svg
      className="absolute -top-6 -left-6 w-[70%] h-[70%] z-0"
      viewBox="0 0 180 180"
    >
      <rect x="0" y="0" width="180" height="180" fill="none" stroke="#3B82F6" strokeWidth="3" />
    </svg>
    {/* Top-left dotted circle */}
    <svg
      className="absolute -top-10 -left-10 w-28 h-28 z-0"
      viewBox="0 0 112 112"
    >
      <circle cx="56" cy="56" r="52" fill="none" stroke="#3B82F6" strokeWidth="3" strokeDasharray="2,6" opacity="0.5" />
    </svg>
    {/* Main image (topmost layer) */}
    <div className="absolute left-1/2 top-1/2 z-10"
      ...
      <img
        src={img1}
        alt="Happy couple in front of house"
        className="w-56 h-56 sm:w-72 sm:h-72 object-cover border-2 border-blue-400 shadow-lg"
  ...
  <div className="w-full md:w-1/2 flex flex-col items-start justify-center text-left max-w-xl">
    ...
    <div className="flex flex-col gap-4 w-full">
      {/* Feature 1 - outlined box */}
      <div className="flex items-start gap-4 p-4 border-2 border-blue-300 rounded-lg">
        <div className="bg-blue-50 rounded-full p-2 flex items-center justify-center">
          <svg width="28" height="28" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="9" stroke="#3B82F6" strokeWidth="2"/><path d="M12 8v4l2 2" stroke="#3B82F6" strokeWidth="2" strokeLinecap="round"/></svg>
        </div>
        <div>
      ...
      <div className="flex items-start gap-4">
        <div className="bg-blue-50 rounded-full p-2 flex items-center justify-center">
          <svg width="28" height="28" fill="none" viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="3" stroke="#3B82F6" strokeWidth="2"/><path d="M8 8h.01M12 8h.01M16 8h.01M8 12h.01M12 12h.01M16 12h.01M8 16h.01M12 16h.01M16 16h.01" stroke="#3B82F6" strokeWidth="2" strokeLinecap="round"/></svg>
        </div>
        <div>
      ...
      <div className="flex items-start gap-4">
        <div className="bg-blue-50 rounded-full p-2 flex items-center justify-center">
          <svg width="28" height="28" fill="none" viewBox="0 0 24 24"><path d="M4 17V7a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v10" stroke="#3B82F6" strokeWidth="2"/><path d="M8 10h8M8 14h5" stroke="#3B82F6" strokeWidth="2" strokeLinecap="round"/></svg>
        </div>
        <div>
      ...
      <div className="flex items-start gap-4">
        <div className="bg-blue-50 rounded-full p-2 flex items-center justify-center">
          <svg width="28" height="28" fill="none" viewBox="0 0 24 24"><path d="M4 17V7a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v10" stroke="#3B82F6" strokeWidth="2"/><path d="M8 10h8M8 14h5" stroke="#3B82F6" strokeWidth="2" strokeLinecap="round"/><circle cx="12" cy="18" r="2" stroke="#3B82F6" strokeWidth="2"/></svg>
        </div>
        <div>
