...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f5faff] flex flex-col overflow-x-hidden">
      ...
      <nav className="w-full bg-white shadow-sm flex items-center justify-between px-4 sm:px-8 py-3 sticky top-0 z-10">
        ...
        <button
          ...
          className="p-2 rounded hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-400 md:hidden"
        >
        ...
        <div className="hidden md:flex gap-6 mx-auto">
          <a href="#" className="text-gray-700 hover:text-blue-600 font-medium transition min-h-[44px] flex items-center">Home</a>
          <a href="#" className="text-gray-700 hover:text-blue-600 font-medium transition min-h-[44px] flex items-center">Services</a>
          <a href="#" className="text-gray-700 hover:text-blue-600 font-medium transition min-h-[44px] flex items-center">Management</a>
          <a href="#" className="text-gray-700 hover:text-blue-600 font-medium transition min-h-[44px] flex items-center">Pricing</a>
          <a href="#" className="text-gray-700 hover:text-blue-600 font-medium transition min-h-[44px] flex items-center">Blog</a>
          <a href="#" className="text-gray-700 hover:text-blue-600 font-medium transition min-h-[44px] flex items-center">Contact</a>
        </div>
        {/* CTA Button (desktop only) */}
        <a href="#" className="hidden md:flex bg-blue-600 hover:bg-blue-700 text-white font-semibold px-5 py-2 rounded-md shadow transition text-sm min-h-[44px] items-center justify-center">
          GET STARTED
        </a>
      </nav>
      {/* Mobile Menu Overlay */}
      {mobileMenuOpen && (
        <div className="fixed inset-0 bg-white bg-opacity-95 z-50 flex flex-col items-center justify-start pt-24 px-8 space-y-6 text-lg font-medium text-gray-700 transition-all duration-300 md:hidden">
          <a href="#" className="w-full text-center py-3 border-b border-gray-200">Home</a>
          <a href="#" className="w-full text-center py-3 border-b border-gray-200">Services</a>
          <a href="#" className="w-full text-center py-3 border-b border-gray-200">Management</a>
          <a href="#" className="w-full text-center py-3 border-b border-gray-200">Pricing</a>
          <a href="#" className="w-full text-center py-3 border-b border-gray-200">Blog</a>
          <a href="#" className="w-full text-center py-3 border-b border-gray-200">Contact</a>
          <a href="#" className="w-full text-center py-3 bg-blue-600 text-white rounded-md mt-4">GET STARTED</a>
          <button
            onClick={() => setMobileMenuOpen(false)}
            aria-label="Close menu"
            className="absolute top-6 right-6 p-2 rounded hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-400"
          >
            <svg width="28" height="28" fill="none" viewBox="0 0 24 24">
              <path d="M6 6l12 12M6 18L18 6" stroke="#3B82F6" strokeWidth="2" strokeLinecap="round"/>
            </svg>
          </button>
        </div>
      )}
      ...
      <main className="flex-1 flex flex-col justify-center items-center px-4 py-8 sm:py-16">
        <div className="w-full max-w-6xl flex flex-col-reverse md:flex-row items-center gap-8 md:gap-16">
          ...
          <div className="w-full flex justify-center items-center mb-8 md:mb-0">
            <img
              ...
              className="w-full max-w-[320px] sm:max-w-[400px] h-auto rounded-md shadow-lg border border-gray-100 object-cover"
              style={{ aspectRatio: '1/1' }}
            />
          </div>
          {/* Left: Text (now below image on mobile) */}
      ...
      <section className="w-full flex flex-col md:flex-row items-center justify-center px-4 py-20 bg-white gap-12 md:gap-20">
        ...
        <div className="relative w-full flex justify-center items-center mb-8 md:mb-0">
          {/* Rectangle: Top-left (under image) */}
          <svg
            className="absolute top-[-54px] right-[-8px] w-[200px] sm:w-[328px] h-[200px] sm:h-[328px] z-0"
            viewBox="0 0 328 328"
          >
          ...
          <svg
            className="absolute bottom-[20px] left-[-8px] w-[200px] sm:w-[328px] h-[200px] sm:h-[328px] z-0"
            viewBox="0 0 328 328"
          >
            <rect width="328" height="328" fill="none" stroke="#3B82F6" strokeWidth="3" />
          </svg>
          ...
          <img
            src={dottedCircle}
            alt="Dotted circle background"
            className="absolute top-[-26px] left-[-20px] w-[70px] sm:w-[113px] h-[70px] sm:h-[113px] z-0 object-contain"
            draggable="false"
          />
        ...
        <div className="w-full md:w-1/2 flex flex-col items-start justify-center text-left max-w-xl">
          ...
          <ul className="mb-5 space-y-4">
            {["Rules are complex and inconsistent","Legal advice costs thousands","Violations cause disputes, fines, and lawsuits","Homeowners often feel powerless",].map((text, i) => (
          ...
          <a
            href="#"
            className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-md text-base shadow-md transition w-full sm:w-auto text-center min-h-[44px]"
          >
            READ MORE ABOUT US
          </a>
        </div>
      ...
      {/* Solutions Section */}
      <section className="w-full bg-[#f3f8fe] py-12 sm:py-16 flex flex-col items-center justify-center">
        ...
        <div className="w-full max-w-6xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 px-2 sm:px-4">
          {/* Card 1 */}
          <div className="bg-white rounded-md shadow-md flex flex-col items-center p-5 sm:p-8 text-center w-full">
      ...
      <section className="w-full flex flex-col md:flex-row items-center justify-center px-4 py-16 bg-white">
        {/* Left: Text and Features */}
        <div className="w-full md:w-1/2 flex flex-col items-start justify-center text-left max-w-xl order-last md:order-first">
        ...
        <div className="relative w-full flex justify-center items-center mt-4 mb-8 md:mt-0 md:mb-0 md:ml-12 order-first md:order-last">
          {/* Rectangle: Top-left (under image) */}
          <svg
            className="absolute top-[-54px] right-[-8px] w-[200px] sm:w-[328px] h-[200px] sm:h-[328px] z-0"
            viewBox="0 0 328 328"
      ...
      <section className="w-full flex flex-col md:flex-row items-center justify-center px-4 py-20 bg-white gap-12 md:gap-20">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-start justify-center text-left max-w-xl">
          ...
          <a
            href="#"
            className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-md text-sm shadow-md transition w-full sm:w-auto text-center min-h-[44px]"
          >
      ...
      <section className="w-full bg-[#f3f8fe] py-12 sm:py-20 flex flex-col items-center justify-center">
        ...
        <div className="w-full max-w-6xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8 px-2 sm:px-4">
      ...
      <section className="w-full py-12 sm:py-20 flex flex-col items-center justify-center bg-white">
        ...
        <div className="relative w-full max-w-6xl flex items-center justify-center">
          {/* Left Arrow */}
          <button className="absolute left-[-16px] sm:left-[-32px] top-1/2 -translate-y-1/2 bg-white rounded-full shadow p-2 flex items-center justify-center hover:bg-blue-50 transition hidden md:flex">
          ...
          {/* Right Arrow */}
          <button className="absolute right-[-16px] sm:right-[-32px] top-1/2 -translate-y-1/2 bg-blue-600 text-white rounded-full shadow p-2 flex items-center justify-center hover:bg-blue-700 transition hidden md:flex">
        ...
        <button className="mt-8 sm:mt-12 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-md text-base shadow-md transition w-full sm:w-auto min-h-[44px]">JOIN THE WAITLIST</button>
      </section>
      {/* Early Access CTA Section */}
      <section className="w-full flex flex-col md:flex-row items-stretch justify-center min-h-[240px] sm:min-h-[340px]">
        {/* Left: Blue CTA */}
        <div className="flex-1 bg-blue-600 flex flex-col justify-center px-4 sm:px-8 py-8 sm:py-12 md:py-0 md:px-16">
          ...
          <button className="bg-white text-blue-700 font-semibold px-8 py-3 rounded-md text-base shadow-md transition w-full sm:w-fit hover:bg-blue-50 min-h-[44px]">JOIN THE WAITLIST</button>
        </div>
        {/* Right: Image */}
        <div className="flex-1 min-h-[180px] sm:min-h-[340px] flex items-center justify-center overflow-hidden">
          <img
            src={img1}
            alt="Happy couple in front of house"
      ...
      {/* Footer Section */}
      <footer className="w-full bg-white pt-12 sm:pt-16 pb-6 px-2 sm:px-4 md:px-0">
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-10 md:gap-6">
          ...
          <div>
            ...
            <form className="flex flex-col sm:flex-row items-stretch bg-blue-50 rounded-md overflow-hidden gap-2 sm:gap-0">
              <input type="email" placeholder="Enter Your Email" className="bg-blue-50 px-4 py-2 outline-none text-gray-700 w-full min-h-[44px]" />
              <button type="submit" className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-2 flex items-center justify-center min-h-[44px]">
